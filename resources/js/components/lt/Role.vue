<template>
    <div class="table-responsive container">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="updateRole">
                            <div class="row">
                                <div class="col">
                                    <label>Role Id</label>
                                    <input type="text" class="form-control" disabled v-model="updateRoleName.id" />
                                </div>
                                <div class="col">
                                    <label>Role Name</label>
                                    <input type="text" class="form-control" disabled v-model="updateRoleName.name" />
                                </div>
                            </div>
                            <div class="row">                                
                                <div class="col">
                                    <label>Role Name</label>
                                    <input type="text" class="form-control" v-model="updateRoleName.new" />
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col">
                                    <button class="btn btn-primary w-100" style="color:white" type="submit">Update {{ this.updateRoleName.name }}</button>
                                </div>
                            </div>
                        </form>                      
                    </div>
                    <div class="modal-footer">
                        <div class="col">
                            <button style="color: white" class="w-100 btn btn-danger" @click="deleteRole(updateRoleName.id)">Delete {{ this.updateRoleName.name }}</button>
                        </div>
                        <div class="col">
        ...
        <table class="table" id="roleInformationTable">
            <thead>
                <tr>
                    <th scope="col">Id</th>
            ...
            <tbody>
                <tr v-for="role in roles" :key="role.id">
                    ...
                    <td>
                        <!-- open modal -->
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="modalOpen(role.id)">
                            Edit
                        </button>
                    </td>           
                </tr>                
