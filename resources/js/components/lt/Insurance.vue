                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" v-model="form.PatId" id="PatId" aria-label="PatIdHelp" aria-describedby="PatIdHelp" required>                                    
                        ...
                        <form @submit.prevent="updatePatientInsurance">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        <label for="PatId" class="form-label">Patient name</label>
                                        <input type="hidden" class="form-control" v-model="updateform.PatId" oninput="this.value = this.value.toUpperCase()" style="text-transform:uppercase" id="PatId" aria-describedby="PatIdHelp" disabled>
                                        <input type="text" class="form-control" v-model="updateform.PatName" id="PatName" aria-describedby="PatNameHelp" disabled>
                                        <div id="PatIdHelp" class="form-text">This is patient's name.</div>
                                    </div>          
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        <label for="InsName" class="form-label">Insurance Name</label>
                                        <input type="text" class="form-control" v-model="updateform.InsName" oninput="this.value = this.value.toUpperCase()" style="text-transform:uppercase" id="InsName" aria-describedby="InsNameHelp" required>
                                        <div id="InsNameeHelp" class="form-text">Please input insurance's name.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        <label for="InsMedicalCardNumber" class="form-label">Medical Card Number</label>
                                        <input type="text" class="form-control" v-model="updateform.InsMedicalCardNumber" id="InsMedicalCardNumber" @keypress="isNumber($event)" aria-describedby="InsMedicalCardNumberHelp" maxlength="10" required>
                                        <div id="InsMedicalCardNumberHelp" class="form-text">Please input insurance's contact number.</div>
                                    </div>
                                </div>  
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="mb-3">
                                        <label for="InsType" class="form-label">Type</label>
                                        <input class="form-control" type="text" v-model="updateform.InsType" id="InsType" aria-label="InsTypeHelp">                              
                                        <div id="InsTypeHelp" class="form-text">Please input insurance's nationality.</div>
                                    </div>
                                </div>                        
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label for="InsExpiryDate" class="form-label">Expiry Date</label>
                                        <input type="date" class="form-control" v-model="updateform.InsExpiryDate" id="InsExpiryDate" aria-describedby="InsExpiryDateHelp" required>
                                        <div id="InsExpiryDateHelp" class="form-text">Please input insurance's address line 1.</div>
                                    </div>
                                </div>
                            </div>                           
                            <button type="submit" style="width: 100%; color: white" class="btn btn-primary">Update {{ this.updateform.InsName }}</button>
                        </form>                       
                    </div>
                    <div class="modal-footer">
                        <div class="col">
                            <button style="color: white" class="w-100 btn btn-danger" @click="deletePatientInsurance(updateform.id)">Delete {{ this.updateform.InsName }}</button>
                        </div>
                        <div class="col">
        ...
        methods: {
            ...
            modalOpen(insuranceId) {
                ...
                .then(res => {
                    ...
                    this.updateform.InsMedicalCardNumber = this.insuranceUpdate.medical_card_no;
