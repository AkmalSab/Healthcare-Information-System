<template>
  <div class="table-responsive container">
              ...
              <div class="row">
                <div class="col">
                  ...
                  <input
                    ...
                    class="form-control"
                    disabled
                    v-model="updateCaseName.oldCaseId"
                  />
                </div>
                <div class="col">
                  ...
                  <input
                    ...
                    class="form-control"
                    disabled
                    v-model="updateCaseName.oldCaseName"
                  />
                </div>
              </div>
              <div class="row">
                <div class="col">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    v-model="updateCaseName.newCaseName"
                  />
                </div>
              </div>
              <div class="row mt-2">
                <div class="col">
                  <button
                    ...
                    type="submit"
                  >
                    Update {{ updateCaseName.oldCaseName }}
                  </button>
                </div>
              </div>
            </form>
          ...
          <div class="modal-footer">
            <div class="col">
              <button
                ...
                @click="deleteCase(updateCaseName.oldCaseId)"
              >
                Delete {{ updateCaseName.oldCaseName }}
              </button>
            </div>
            <div class="col">
              <button
    ...
    <div class="card mt-3">
      <div class="card-body">
        <table class="table mt-2 text-center" id="typeOfCaseInformationTable">
          <thead>
            <tr>
              <th scope="col">ID</th>
          ...
          <tbody>
            <tr v-for="casex in cases" :key="casex.id">
              ...
              <td>{{ casex.name }}</td>
              <td>{{ casex.created_at | formatDate }}</td>
              <td>{{ casex.updated_at | formatDate }}</td>
              <td>
                <!-- open modal -->
                <button
                  type="button"
      ...
      axios
        ...
        .then((res) => {
          Swal.fire({
            ...
            if (res.isConfirmed) {
              $("#typeOfCaseInformationTable").DataTable().destroy()
              this.getTypeofCase()
            }
          });
        })
