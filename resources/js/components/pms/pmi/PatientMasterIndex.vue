<template>
    <div class="container">
        <h1 class="text-center">Patient Master Index</h1>

        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 g-4 mt-4">
            <div class="col mb-3">
                <div class="card h-100">
                    ...
                    <div class="m-4 d-flex flex-row">   
                        <router-link :to="{name: 'pmsPatientAppointmentInformation'}" class="btn btn-primary w-100">Visit</router-link>
                    </div>
                </div>
            </div>
            <div class="col mb-3">
                <div class="card h-100">
                    ...
                    <div class="m-4 d-flex flex-row">   
                        <router-link :to="{name: 'PmsPatientBiodata'}" class="btn btn-primary w-100">Visit</router-link>
                    </div>
                </div>
            </div>
            <div class="col mb-3">
