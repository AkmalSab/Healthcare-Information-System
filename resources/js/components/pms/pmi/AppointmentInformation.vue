<template>
  <div class="table-responsive container">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="mb-3">
                ...
                <div id="PatNameHelp" class="form-text">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="mb-3">
                ...
                >
                  <option
                    v-for="casex in cases"
                    v-bind:key="casex.id"
                    v-bind:value="casex.id"
                  >
                    {{ casex.name }}
                  </option>
                </select>
                <div id="AppTocHelp" class="form-text">
                  Please input appointment's case type.
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="mb-3">
                <label for="AppDesc" class="form-label"
                ...
                <input
                  ...
                  required
                />
                <div id="AppDescHelp" class="form-text">
                  Please input appointment's purpose.
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="mb-3">
                ...
                <input
                  ...
                  required
                />
                <div id="AppDateHelp" class="form-text">
                  Please input appointment's date.
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="mb-3">
                ...
                />
                <div id="AppTimeHelp" class="form-text">
                  Please input appointment's time.
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="card">
      <div class="card-body">
        <table class="table text-center" id="appointmentInformationTable">
          <thead>
            <tr>
              <th scope="col">ID</th>
