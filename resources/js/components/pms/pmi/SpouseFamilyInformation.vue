    ...
    <div class="table-responsive container">
        ...
        <div class="card">
            <div class="card-header">
                List of registered patient's next of kin
            </div>
            <div class="card-body">
        ...
        modalOpen(familyId) {
            axios
                ...
                .then(res => {
                    ...
                    this.form.NokGender = this.familyUpdate.gender;
                    this.form.NokInsurance = this.familyUpdate.insurance_id;
        ...
        updatePatientNextofKin() {
            axios
                .put("/api/family/" + this.form.NokId, {
                    ...
                    insurance_id: this.form.NokInsurance,
