<template>
  <div class="container">
    <div v-if="patientsInsurance.length == 0" class="card">
      <div class="card-body text-center">
        <h1>PLEASE REGISTER PATIENT INSURANCE</h1>
        <router-link :to="{ name: 'pmsPatientRegisterInsurance', params: { id: $route.params.id }}" style="color:white" class="btn btn-primary">Visit</router-link>
      </div>
    </div>
    <div v-else>
              ...
              <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="mb-3">
                  ...
                  <div id="NokGenderHelp" class="form-text">
                    Please input patient's emergency contact gender.
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      <button
        v-if="patientsInsurance.length == 0"
        type="button"
        id="errorBackdropButton"
        class="btn btn-primary invisble"
        data-bs-toggle="modal"
        data-bs-target="#errorBackdrop"
      >
        error
      </button>
      ...
      <div
        ...
        data-bs-keyboard="false"
        tabindex="-1"
        aria-labelledby="errorBackdropLabel"
        aria-hidden="true"
      >
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="errorBackdropLabel">
            ...
            <div class="modal-footer">
              <button
                ...
                class="btn btn-primary"
                data-bs-dismiss="modal"
                v-on:click="returnPatientBiodata"
              >
      ...
      axios
        ...
        .then((res) => {
          Swal.fire({
            ...
            if (res.isConfirmed) {
              $("#patNextOfKinTable").DataTable().destroy();
              this.getPatientNextofKin();
            }
          });
        })
