        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            <label for="selectPat" class="form-label">Select Patient</label>
                            <select class="form-select" aria-label="Default select example" aria-describedby="selectPatHelp">
                                <option selected>Open this select menu</option>
                                <option value="Malaysia">Malaysia</option>
                            </select>
                            <div id="selectPatHelp" class="form-text">Please choose patient.</div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            <label for="selectBlood" class="form-label">Select Blood Group</label>
                            <select class="form-select" aria-label="Default select example" aria-describedby="selectBloodHelp">
                                <option selected>Open this select menu</option>
                            ...
                            <div id="selectBloodHelp" class="form-text">Please choose blood group.</div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <h4>Immunisation Record (Vaccine)<span><button class="btn btn-outline-danger btn-sm ms-3">Refresh</button></span></h4>
                <div class="row">
                    <div class="col">
                        <div class="mt-3">
                            <h5>Name</h5>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mt-3">
                            ...
                            <span class="badge bg-success" v-if="vaxInfo.appt_complete1 == 1">Selesai</span>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mt-3">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mt-3">
                            <h5>Status Janji Temu</h5>
                            <span class="badge bg-success" v-if="vaxInfo.appt_complete2 == 1">Selesai</span>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mt-3">
