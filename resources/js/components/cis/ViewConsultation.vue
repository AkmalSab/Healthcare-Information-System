            ...
            <div class="row">
              <div class="col">
                ...
                <input
                  type="text"
                  readonly
                  class="form-control-plaintext fs-3"
                  v-model="modal.patName"
                />
              </div>
              <div class="col">
    ...
    >
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Are you sure want to delete consultation (#{{ delete_modal.id }})
            {{ delete_modal.patName }}
          </div>
          <div class="modal-footer">
            <button
              id="closeModal"
            ...
            <button
              ...
              style="color: white"
              @click="deleteConsultation(delete_modal.id)"
            >
              Delete
            </button>
          </div>
        ...
        <table class="table text-center">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                {{ consultation.patient_created_date | formatDate }}
              </td>
              <td>
                <button
                  type="button"
                ...
                <router-link
                  :to="{ name: 'pisCreatePrescription' }"
                  class="btn btn-success"
                  style="color: white"
                  >Order Prescription</router-link
                >
                <button
                  type="button"
                  class="btn btn-danger"
                  ...
                  @click="deleteModal(index, consultation.id)"
                >
                  Delete
                </button>
              </td>
...
export default {
  ...
  methods: {
    modalOpen: function (i, id) {
      ...
      this.modal.patDisability =
        this.consultationData[i].patient_disability_hist;
      return (this.active = i);
    },
    deleteModal: function (i, id) {
      this.delete_modal.id = this.consultationData[i].id;
      this.delete_modal.patName = this.consultationData[i].patient_name;
      return (this.active = i);
    },
    getConsultationData() {
      axios
